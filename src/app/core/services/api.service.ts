...
// ── User Service (identity-service /api/users) ────────────────────
...
export class UserApiService {
   ...
   * Role values: ADMIN, CLERK, JUDGE, LAWYER, CITIZEN, COMPLIANCE, AUDITOR
   * Used to load lawyers for case filing dropdown.
   */
...
// ── Citizen Service (citizen-service /api/citizens) ───────────────
@Injectable({ providedIn: 'root' })
...
// ── Case Service (case-service /api/cases) ────────────────────────
@Injectable({ providedIn: 'root' })
...
// ── Hearing Service (hearing-service /api/hearings) ───────────────
@Injectable({ providedIn: 'root' })
...
// ── Judgment Service (judgment-service /api/judgments + /api/court-orders) ──
@Injectable({ providedIn: 'root' })
...
// ── Compliance Service (compliance-service /api/compliance + /api/audits) ──
@Injectable({ providedIn: 'root' })
...
// ── Report Service (report-service /api/reports) ──────────────────
@Injectable({ providedIn: 'root' })
...
// ── Audit Log Service (compliance-service /api/audit-logs) ────────
@Injectable({ providedIn: 'root' })
...
// ── File Upload Service (case-service /api/files) ─────────────────
@Injectable({ providedIn: 'root' })
